...
如果对任何实习感兴趣, 请阅读 [如何申请实习](./how-to-submit-application.md) 从此处 [提交申请](https://github.com/ysyx-ta/ysyx-internships/issues/new?assignees=&labels=request&template=internships.yaml).
...
2. 使用 AXI 作为 IP 的总线接口, 接入一生一芯的 SoC.
...
5. 熟悉modern c++且具有面向对象编程思想；
6. 熟练看波形debug以及c++ debug，熟练使用git协作以及良好的注释习惯；
7. 实习期至少18个月以上；
...
2. 开发、维护并改进流片用SoC的仿真框架（iverilog/verilator/vcs）；
3. 协助开源处理器核接入到SoC仿真环境，参与SoC子部件的预综合，为后端团队提供PPA优化参考；
4. 完成SoC子部件的代码开发、功能仿真，能在FPGA上搭建完整的SoC验证环境，并持续优化；
5. 跟踪国内外开源SoC架构设计的前沿进展，参与一生一芯流片用SoC生成器项目的设计和开发；
6. 学习并探索全开源逻辑综合工具链（Yosys+abc）的使用，并接入到一生一芯后端工具链中；
7. 参与SoC仿真用CI/CD平台维护工作，并协助后端团队解决代码接入的问题；
8. 负责SoC架构设计文档的编写和改进；

投递要求:
1. 在读本科或研究生（含博士/硕士），需要线下实习，待遇面议；
2. 具有积极主动的工作态度，具备较强的学习能力，良好的分析能力、解决问题能力、沟通能力和团队协作能力；
3. 熟悉verilog语言和数字电路设计原理，了解SoC数字集成和FPGA逻辑设计相关知识，熟悉AMBA系列总线和各个常见标准外设的协议，具有基本的系统架构分析和优化能力；
4. 熟悉RV32/64指令集和微架构的优先，有总线互联网络开发经验的优先；
5. 熟悉静态时序分析原理，有前后端协同开发经验的优先；
...
投递要求：
- 满足[《Web前端开发实习生》](#9-web前端开发实习生)岗位投递要求中的所有内容。
- 满足[《Web后端开发实习生》](#10-web后端开发实习生)岗位投递要求中的部分内容（只需了解Web基本知识、数据库、后端开发框架即可）。
